...
Cada uno de ellos permite organizar tu trabajo de forma jerarquica.

Vamos a empezar crear una sesión en tmux llmada `main`` y para ello debemos escribir 
en la terminal el comando `tmux new -s main`.

Si nos fijamos abajo en la terminal, vemos esta raya verde lo que significa que 
...
relevante porque la mayoría de los atajos y comandos de tmux empiezan por esta 
combinación.
...
a aprovechar para introducir los panes de `tmux`.
